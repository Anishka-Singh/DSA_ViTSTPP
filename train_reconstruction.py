...
import numpy as np
from API.dataloader_nighttime import load_data

# Load data
dataloader_train, dataloader_validation, dataloader_test, mean, std = load_data(
    batch_size=1, val_batch_size=1, data_root='/home/ansingh/Nuwa_Hawkes/data/nighttime', num_workers=8)
...
# Training function
def train_model(model, dataloader_train, dataloader_valid, optimizer, mse_loss, epochs=3):
...
train_model(vit_model, dataloader_train, dataloader_validation, optimizer, mse_loss, epochs=3)
