...
from .dataloader_nighttime import load_data as load_nighttime
...
def load_data(dataname,batch_size, val_batch_size, data_root, num_workers, **kwargs):
    ...
    elif dataname == 'nighttime':
        return load_nighttime(batch_size, val_batch_size, data_root, num_workers)
